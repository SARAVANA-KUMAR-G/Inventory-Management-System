  ...
  return (
    <div className="space-y-6 max-w-7xl">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          <Button
            ...
            className="flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white shadow-sm font-semibold"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        {/* Total Products */}
        <div className="p-5 bg-white rounded-2xl border border-slate-200/90 shadow-xs flex flex-col justify-between">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 p-6 bg-white rounded-2xl border border-slate-200/90 shadow-xs flex flex-col">
        ...
        {/* Top 5 Products */}
        <div className="p-6 bg-white rounded-2xl border border-slate-200/90 shadow-xs flex flex-col">
          <div className="mb-4">
                ...
                <div key={p.productId || idx} className="flex items-center justify-between gap-3 text-sm">
                  <div className="flex items-center gap-2.5 min-w-0">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xs font-semibold text-slate-600 font-mono">{p.sku} • {p.totalQuantitySold} sold</p>
                    </div>
                  </div>
      ...
      {/* Operational Feeds: Low Stock, Recent Sales, Recent Transactions */}
